        ...
        <Row>
          ...
          <Col>
            <div className={style.infoCol}>
              <span className={style.leftFloat}>Band:</span> <b className={style.rightFloat}>{concert.band}</b>
              <br/>
              <span className={style.leftFloat}>Place:</span> <b
                className={style.rightFloat}>{concert.place}</b>
              <br/>
              <span className={style.leftFloat}>Date:</span> <b className={style.rightFloat}>{concert.date}</b>
              <br/>
            </div>
          </Col>
        </Row>
