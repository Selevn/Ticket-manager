                ...
                <div className={"mainContainer"} id={"mainContainerRef"}>
                  ...
                  <div className={style.mainData}>
                    ...
                    <div className={style.dataRow}>
                      ...
                      <div className={style.oneRow}>
                        <SocialIcon style={{ height: 70, width: 70 }} className={style.socialIcon} url="https://twitter.com/elonmusk" />
                        <SocialIcon style={{ height: 70, width: 70 }} className={style.socialIcon} url="https://www.facebook.com/elonreevesmusk/" />
                        <SocialIcon style={{ height: 70, width: 70 }} className={style.socialIcon} url="https://vk.com/elonmusk" />
                      </div>
                    </div>
                  </div>
                </div>
